...
public class lecture21Test {
    ...
    public void preconditions() {
        connection = DriverManager
                .getConnection("jdbc:mysql://db4free.net/testqa07?user=testqa07&password=testqa07");
    ...
    public void insertTest() {
        print(select("SELECT * FROM user WHERE first_name is null"));
        insert("INSERT INTO user (id, last_name) VALUES (800, 'QA16onl')");
        print(select("SELECT * FROM user WHERE first_name is null"));
    }
